// 20 条手工精编 5D 卡（金标准，生成器不会覆盖）
// 新词条的 5D 数据由 scripts/build-fived.mjs 从 data/seeds5d/*.tsv 生成，见 data/fived.ts
import { FiveD } from "@/types";

export const FIVE_D_CORE: Record<string, FiveD> = {
  // ---------- hablar ----------
  "st-028": {
    meaning: "说；讲（语言）",
